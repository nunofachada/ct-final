...
def create_layout(app):
    ...
    plugin_options = [
        {'label': plugin.replace('_', ' ').title(), 'value': plugin}  # Format plugins for dropdown
    ...
    layout = html.Div([
        ...
        dbc.Container(
            [
                ...
                dbc.Row(dbc.Col(url_error_message, width=12, lg=8), justify="center"),
                dbc.Row(dbc.Col(plugin_error_message, width=12, lg=8), justify="center"),
