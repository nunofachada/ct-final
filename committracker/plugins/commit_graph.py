...
from .git_statistics import extract_git_stats  # Import the function to extract Git statistics
...
def display_commit_graph(repo_path):
    ...
    df['Commit Date'] = df['Commit Date'].dt.tz_convert(None)  # Remove timezone information
